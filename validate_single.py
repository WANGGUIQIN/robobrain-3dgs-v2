...
Validates that the full pipeline runs end-to-end:
    RGBD -> 3D Gaussian -> GS Encoder -> Fusion -> LLM -> Constraint
...
def compute_loss(
    ...
    """Compute combined loss for constraint prediction.
...
def validate_forward_pass():
    ...
    for step in range(20):
        ...
        loss, loss_dict = compute_loss(outputs, sample["gt_constraints"])
        loss.backward()
